...
import role_service_repair as repairs
...
class RoleServiceRepairTests(unittest.TestCase):
    def setUp(self):
        ...
        self.spec = {'sources': [{'path': 'source.java', 'purpose': 'REST roles',
    ...
    def test_packaging_repairs_sources_without_test_injection(self):
        ...
        self.assertEqual(receipt['requires_explicit_role_service_option'], 'strictGeoNodeRoles')
        self.assertEqual(receipt['required_preceding_repairs'], [])
