...
and final criterion evidence are being prepared. This does not adopt the
...
| F02-08 | C1–C4 | Produce the final criterion-by-criterion acceptance report, including unresolved findings and exact owner decision scope. | [Successor criterion-by-criterion report and decision scope](fnd-02-json-nojpeg2000-acceptance.md), this unchanged checklist and linked immutable evidence. | Every unchanged criterion independently evidenced; unresolved selection problems addressed as the criterion permits; explicit later owner acceptance of full FND-02. | Draft report prepared in the same remediation PR. Final exact-WAR/manifest/check evidence must be linked before decision-ready status; explicit owner C1–C4, candidate and maintenance acceptance remains necessary. | FND-02 | **Criterion report prepared; final evidence and owner acceptance pending. Keep In progress.** |
...
JSON and imaging implementations must converge into one exact aggregate before
any previous WAR-consuming receipt is superseded. The
...
Its pending evidence ledger is explicit; this draft is not full-task acceptance.
