...
The host executes these tools through `flatpak-spawn --host` where required. That bridge is not hostile-code isolation. Extraction prefixes are task-owned. The final selected supporting prefix is `build-worktrees/qgis-candidate/support-05/usr`; its adjacent `support-05-inventory.json` records every file hash and symlink. The existing `support`, `support-02`, `support-03`, `support-04` prefixes and unsuccessful/incomplete extraction snapshots are preserved. The selected inventory contains 12,220 entries and has SHA256 `ff029a90babc74fe4a2b256afcb75f93500e8fec77ac374c6ea42575733a7ef8`; its embedded support manifest has SHA256 `68c2ebb7468a34a817afdf56e98dac16f841f34cb75403183a8b513085382425`.
